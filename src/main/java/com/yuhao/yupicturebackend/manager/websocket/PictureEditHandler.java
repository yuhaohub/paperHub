...
import com.yuhao.yupicturebackend.manager.websocket.disruptor.PictureEditEventProducer;
import com.yuhao.yupicturebackend.manager.websocket.model.PictureEditActionEnum;
...
public class PictureEditHandler extends TextWebSocketHandler {
    ...
    protected void handleTextMessage(WebSocketSession session, TextMessage message) throws Exception {
        ...
        // 调用对应的消息处理方法(生产消息到disruptor队列当中)
